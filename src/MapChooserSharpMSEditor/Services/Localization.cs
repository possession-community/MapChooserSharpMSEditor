...
public static class Localization
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> _strings = new()
    {
        ...
        ["ja"] = new()
        {
            ...
            ["Prop.MaxPlayers.Desc"] = "プレイヤー数が この値以下 のときのみNominate可能。",
            ["Prop.MinPlayers.Desc"] = "プレイヤー数が この値以上 のときのみNominate可能。",
            ["Prop.ProhibitAdminNomination.Desc"] = "サーバコンソールからのみNominate可能にする。",
            ["Prop.DaysAllowed.Desc"] = "Nominateを許可する曜日。",
            ["Prop.AllowedTimeRanges.Desc"] = "Nominateを許可する時間帯。",
